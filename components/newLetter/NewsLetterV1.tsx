                    ...
                    <div className="col-xl-6 col-lg-8 offset-xl-3 offset-lg-2">
                        <div className="te-section-title justify-content-center text-center">
                            <div className="te-section-content">
                                ...
                                <h2 className="title">
                                    Technology Making the <br /> World a Smaller Place
                                </h2>
                                <p>
                                    Stay updated with our latest insights, innovations, and news
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="mc4wp-form-fields">
                                    ...
                                    <button className="submit-btn" type="submit" disabled={loading}>
                                        {loading ? "Submitting..." : (
                                            <>Subscribe Now <i className="fa fa-solid fa-arrow-right"></i></>
                                        )}
                                    </button>
                                </div>
                                {status && (
                                    <p
                                        className={`mt-3 ${status.startsWith("✅")
                                            ? "text-success"
                                            : "text-danger"
                                            }`}
                                    >
